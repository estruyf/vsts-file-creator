 ...
 */
export declare enum DefaultGroupDeliveryPreference {
    NoDelivery = -1,
    EachMember = 2
}
...
export interface ProcessingIdentities {
    excludedIdentities?: {
        [key: string]: ProcessingDiagnosticIdentity;
    };
    includedIdentities?: {
        [key: string]: ProcessingDiagnosticIdentity;
    };
...
export declare var TypeInfo: {
    ...
    SubscriptionQueryFlags: {
        enumValues: {
            ...
            "includeSystemSubscriptions": number;
        };
    };
    SubscriptionStatus: {
        enumValues: {
            ...
            "disabledArgumentException": number;
            "disabledProjectInvalid": number;
            "disabledMissingPermissions": number;
            "disabledFromProbation": number;
