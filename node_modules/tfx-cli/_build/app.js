...
function patchPromisify() {
    ...
    var isChakra = jsEngine.indexOf("chakra") >= 0;
    if (isChakra) {
...
(function (Bootstrap) {
    function begin() {
        return __awaiter(this, void 0, void 0, function () {
            var cmd, tfCommand, executor;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, command.getCommand()];
                    case 1:
                        cmd = _a.sent();
                        common.EXEC_PATH = cmd.execPath;
                        return [4 /*yield*/, loader.load(cmd.execPath, cmd.args)];
                    case 2:
                        tfCommand = _a.sent();
                        return [4 /*yield*/, tfCommand.showBanner()];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, tfCommand.ensureInitialized()];
                    case 4:
                        executor = _a.sent();
                        return [2 /*return*/, executor(cmd)];
                }
            });
        });
    }
