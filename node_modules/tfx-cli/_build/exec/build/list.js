...
var buildContracts = require("azure-devops-node-api/interfaces/BuildInterfaces");
var trace = require("../../lib/trace");
function getCommand(args) {
    return new BuildGetList(args);
}
exports.getCommand = getCommand;
var BuildGetList = /** @class */ (function (_super) {
    __extends(BuildGetList, _super);
    function BuildGetList() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.description = "Get a list of builds.";
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.webApi.getBuildApi()];
                    case 1:
                        buildapi = _a.sent();
