...
function getExtInfo(vsixPath, extensionId, publisherName, cachedInfo) {
    ...
    if (cachedInfo) {
        ...
        vsixInfoPromise = util_1.promisify(fs_1.readFile)(vsixPath)
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        zipArchive = new zip();
                        return [4 /*yield*/, zipArchive.loadAsync(data)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, zipArchive];
                }
            });
        }); })
            .then(function (zip) {
            ...
            var foundPublisher = publisherName ||
