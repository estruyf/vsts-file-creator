...
var ExtensionShare = /** @class */ (function (_super) {
    ...
    function ExtensionShare(passedArgs) {
        ...
        _this.description = "Share an Azure DevOps Extension with Azure DevOps Organizations.";
        _this.serverCommand = true;
        _this.registerCommandArgument("shareWith", "Share with", "List of organizations with which to share the extension.", args.ArrayArgument);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        galleryApi = _a.sent();
                        return [2 /*return*/, this.commandArgs.vsix.val(true).then(function (vsixPath) {
                                var extInfoPromise;
                                if (vsixPath !== null) {
                                ...
                                return extInfoPromise.then(function (extInfo) {
                                    return _this.commandArgs.shareWith.val().then(function (shareWith) {
                                        ...
                                        shareWith.forEach(function (account) {
                                            sharePromises.push(publish_1.SharingManager.shareExtension(galleryApi, extInfo.publisher, extInfo.id, account));
                                        });
