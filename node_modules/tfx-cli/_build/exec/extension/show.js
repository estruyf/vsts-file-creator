...
var ExtensionShow = /** @class */ (function (_super) {
    __extends(ExtensionShow, _super);
    function ExtensionShow() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.description = "Show info about a published Azure DevOps Services Extension.";
    ...
    ExtensionShow.prototype.setCommandArgs = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        galleryApi = _a.sent();
                        return [2 /*return*/, this.identifyExtension().then(function (extInfo) {
