...
var witContracts = require("azure-devops-node-api/interfaces/WorkItemTrackingInterfaces");
    ...
    WorkItemQuery.prototype.exec = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.webApi.getWorkItemTrackingApi()];
                    case 1:
                        witApi = _a.sent();
                        return [2 /*return*/, this.commandArgs.project.val(true).then(function (projectName) {
